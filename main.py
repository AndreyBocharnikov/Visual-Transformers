...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--model",
                        help="Provide ResNet18 or VT_ResNet18 for classification, ... or ... for semantic segmentation.")
    ...
    parser.add_argument("--save_model_path", default="/content/drive/MyDrive/ML/weights/semantic_segmentation/",
                        help="Dont add .pt, it will be added after epoch number")
...
def load_model_and_optimizer(args: Namespace) -> tp.Tuple[nn.Module, optim.SGD, optim.lr_scheduler.StepLR]:
...
def train(args: Namespace, model: nn.Module, optimizer: optim.SGD, scheduler, train_dataloader: DataLoader,
    ...
    for epoch in range(args.current_epoch + 1, args.epochs + 1):
        ...
        torch.save({'epoch': epoch,
                   ...
                   args.save_model_path + "state_dict_" + args.model + "_" + str(epoch) + ".pt")
